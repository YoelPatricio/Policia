 ...
 * @author Yoel
 */
public class dlgArmasIncautadas extends javax.swing.JDialog {
    ...
    public dlgArmasIncautadas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarDatos();
    ...
    private void initComponents() {
        ...
        txtDescArma = new javax.swing.JTextField();
        jButton1 = new javax.swing.JButton();
        txtIdArma = new javax.swing.JLabel();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Agregar Arma", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
        ...
        txtDescArma.setEditable(false);
        txtDescArma.setOpaque(false);

        jButton1.setText("Selecciona Arma");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtIdArma, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtDescArma, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 39, Short.MAX_VALUE)
                        .addComponent(jButton1)
                        .addGap(34, 34, 34))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txtSerie, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel19)
                    .addComponent(txtDescArma, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtIdArma))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
           dlgRegistrarOperativo.armasIncautadoList = this.armasIncautadoList;
           this.dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        dlgListadoArmas la = new dlgListadoArmas(null, rootPaneCheckingEnabled);
        la.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        Arma a = new Arma();
        a.setIdArma(Integer.parseInt(txtIdArma.getText()));
        a.setMarca(txtMarca.getText());
        a.setDescripcion(txtDescripcion.getText());
        
        ai.setArma(a);
        ai.setSerie(txtSerie.getText());
        ai.setDescripcion(txtDescArma.getText());
        
        armasIncautadoList.add(ai);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgArmasIncautadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgArmasIncautadas dialog = new dlgArmasIncautadas(new javax.swing.JFrame(), true);
    ...
    public static javax.swing.JTextField txtDescArma;
    private javax.swing.JTextArea txtDescripcion;
    public static javax.swing.JLabel txtIdArma;
    ...
    public void cargarDatos() {
        ...
        if(armasIncautadoList==null){
            return;
        }
        
        
        
        List<ArmaIncautada> datos = armasIncautadoList;
        ...
        for (int i = 0; i < datos.size(); i++) {
            ...
            matriz[i][0] = datos.get(i).getArma().getMarca();
            matriz[i][1] = datos.get(i).getSerie();
            matriz[i][2] = datos.get(i).getDescripcion();
 
        }
        Object[][] data = matriz;
        String[] cabecera = {"Marca","Serie", "Descripción"};
