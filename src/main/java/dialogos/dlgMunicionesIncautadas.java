 ...
 * @author Yoel
 */
public class dlgMunicionesIncautadas extends javax.swing.JDialog {
    ...
    public dlgMunicionesIncautadas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarDatos();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Agregar Munición", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtMarca, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(24, 24, 24)
                        .addComponent(jLabel20)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtCalibre, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
           dlgRegistrarOperativo.municionesIncautadoList = this.municionesIncautadoList;
           this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgMunicionesIncautadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgMunicionesIncautadas dialog = new dlgMunicionesIncautadas(new javax.swing.JFrame(), true);
    ...
    public static javax.swing.JTextField txtCalibre;
    ...
    public void cargarDatos() {
        ...
        if(municionesIncautadoList==null){
            return;
        }
        
        
        
        List<Municion> datos = municionesIncautadoList;
        ...
        for (int i = 0; i < datos.size(); i++) {
            ...
            matriz[i][0] = datos.get(i).getMarca();
            matriz[i][1] = datos.get(i).getCalibre();
            matriz[i][2] = datos.get(i).getCantidad();
            matriz[i][3] = datos.get(i).getDescripcion();
 
        }
        Object[][] data = matriz;
        String[] cabecera = {"Marca","Calibre", "Cantidad", "Descripción"};
