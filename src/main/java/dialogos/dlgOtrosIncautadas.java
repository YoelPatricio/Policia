 ...
 * @author Yoel
 */
public class dlgOtrosIncautadas extends javax.swing.JDialog {
    ...
    public dlgOtrosIncautadas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarDatos();
    }
    ...
    private void initComponents() {
        ...
        if (tableDatos.getColumnModel().getColumnCount() > 0) {
            tableDatos.getColumnModel().getColumn(0).setMinWidth(20);
        }

        jLabel7.setFont(new java.awt.Font("Roboto", 1, 48)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(128, 128, 131));
        jLabel7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel7.setText("Otros Objetos");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
           dlgRegistrarOperativo.otrosIncautadoList = this.otrosIncautadoList;
           this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgOtrosIncautadas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgOtrosIncautadas dialog = new dlgOtrosIncautadas(new javax.swing.JFrame(), true);
    ...
    public void cargarDatos() {
        ...
        if(otrosIncautadoList==null){
            return;
        }
        
        
        
        List<Otro> datos = otrosIncautadoList;
        ...
        for (int i = 0; i < datos.size(); i++) {
            ...
            matriz[i][1] = datos.get(i).getDescripcion();
 
        }
        Object[][] data = matriz;
        String[] cabecera = {"Nombre","Descripción"};
