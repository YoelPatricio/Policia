 ...
 * @author Yoel
 */
public class dlgRegistrarPersona2 extends javax.swing.JDialog {

    /**
     * Creates new form persona
     */
    public dlgRegistrarPersona2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cboTipoPersona.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--SELECCIONE--", "CIUDADANO", "POLICIA" }));
        cboTipoPersona.setOpaque(false);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        per.setTipoPerso(cboTipoPersona.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgRegistrarPersona2 dialog = new dlgRegistrarPersona2(new javax.swing.JFrame(), true);
