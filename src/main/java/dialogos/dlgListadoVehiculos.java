 ...
 * @author Yoel
 */
public class dlgListadoVehiculos extends javax.swing.JDialog {

    /**
     * Creates new form dlgListadoPapeletas
     */
    DefaultTableModel dtm;
    public dlgListadoVehiculos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cargarDatos();
    }
    ...
    private void tableDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDatosMouseClicked
        if(evt.getClickCount()==2){
            ...
            dlgVehiculosIncautados.txtIdVehiculo.setText(String.valueOf(tableDatos.getValueAt(selection, 0)));
            dlgVehiculosIncautados.txtMarca.setText(String.valueOf(tableDatos.getValueAt(selection, 1)));
            dlgVehiculosIncautados.txtModelo.setText(String.valueOf(tableDatos.getValueAt(selection, 2)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgListadoVehiculos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgListadoVehiculos dialog = new dlgListadoVehiculos(new javax.swing.JFrame(), true);
    ...
    private void cargarDatos() {
        ...
        List<Object> datos = dao.getVehiculos(txtBuscar.getText());
        ...
        Object[][] data = matriz;
        String[] cabecera = {"Código", "Marca","Modelo", "Año"};
