...
import dialogos.dlgRegistrarPersona2;
...
public class pnlPersonas extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        dlgRegistrarPersona2 sp = new dlgRegistrarPersona2(null, true);
        sp.setVisible(true);
    ...
    public void cargarDatos() {
        ...
        List<Object> datos = dao.getPersonasList(txtBuscar.getText());
        ...
        Object[][] data = matriz;
        String[] cabecera = {"Código", "DNI","Apellidos y Nombres","Nivel Estudios/Grado","Ocupación", "Tipo Persona","Perfil"};
