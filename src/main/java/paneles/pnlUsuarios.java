...
import dialogos.dlgRegistrarUsuario;
...
public class pnlUsuarios extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        dlgRegistrarUsuario sp = new dlgRegistrarUsuario(null, true);
        sp.setVisible(true);
    ...
    public void cargarDatos() {
        ...
        List<Object> datos = dao.getUsuarios(txtBuscar.getText());
        ...
        Object[][] data = matriz;
        String[] cabecera = {"Código","Apellidos y Nombres","Perfil","Usuario"};
